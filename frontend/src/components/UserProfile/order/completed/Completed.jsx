...
const Completed = ({OrderedItem}) => {
  // const { orderItem } = useContext(orderContext);
  // const [totalPrice, setTotalPrice] = useState();
  // console.log(orderItems);

  // const [CompletedItem, setCompletedItem] = useState(data);
  ...
  return (
    <>
      <div className="user-page-order-Completed-section">
        {/* {setCompletedItem((prevItem) => {
          ViewData.filter((item) => {
            return item.orderS === "Completed";
          });
        })}
      */}
        {orderItems}
