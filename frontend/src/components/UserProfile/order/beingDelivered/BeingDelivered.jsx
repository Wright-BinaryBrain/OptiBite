...
const BeingDelivered = ({OrderedItem,}) => {
  ...
  return (
    <>
      <div className="user-page-order-BeingDelivered-section">
        {/* {setBeingDeliveredItem((prevItem) => {
          ViewData.filter((item) => {
            return item.orderS === "BeingDelivered";
          });
        })}
      */}
       {orderItems}
