...
function ShopFilter(props) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/api/v1/getAllProductFamily")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/api/v1/getAllProductType")
  ...
  return (
    <div className="filter-container">
      ...
      <div className="product-categories-container">
        {ProductFamilyList.current.map((familyValue, familyIndex) => {
          return (
            <div className="family-and-type-container">
              <div className="product-family-container">
                ...
                <div
                  className="product-family-list-btn"
                  onClick={() => handleBtnClick(familyValue._id)}
                >
                  <div className="product-family-line1"></div>
                  <div
                    className="product-family-line2"
                    style={
                      BooleanList[familyIndex]
              ...
              {ProductTypeList.current.map((typeValue) => {
                return (
                  <div
                    className="product-type-container"
                    style={
                      BooleanList[familyIndex] &&
                      ProductFamilyList.current[familyIndex]._id ===
                        typeValue.productFamilyId
                        ? { maxHeight: "350px" }
                        : { maxHeight: "0" }
                    }
                  >
      ...
      <div className="shop-type-header">TYPE</div>
      <div className="shop-type-container">
        <div className="shop-type-option-container">
          <input
            ...
            name="vegNonVeg"
            onChange={(event) =>
              props.filterChange(event, ["vegNonVeg", "Veg"])
            }
          />
          <div>Veg</div>
        </div>
        <div className="shop-type-option-container">
          <input
            ...
            name="vegNonVeg"
            onChange={(event) =>
              props.filterChange(event, ["vegNonVeg", "Non veg"])
            }
          />
          <div>Non-Veg</div>
        </div>
        ...
        <div
          className="shop-type-option-container"
        ...
        >
          <input
            ...
            name="edibleType"
            onChange={(event) =>
              props.filterChange(event, ["edibleType", "Yes"])
            }
          />
          <div>Edible</div>
        </div>
        <div className="shop-type-option-container">
          <input
            ...
            name="edibleType"
            onChange={(event) =>
              props.filterChange(event, ["edibleType", "No"])
            }
          />
          <div>Non-Edible</div>
        </div>
      ...
      <div className="filter-by-price-container">
        <div className="filter-by-price-header">FILTER BY PRICE</div>
        ...
        <div className="price-range-input-container">
          <Slider
            ...
            onChangeCommitted={(event) =>
              props.priceChange(event, ["priceChange"])
            }
        ...
        <div className="shop-price-range">
          Price: Rs.{props.priceRangeValue[0]} - Rs.{props.priceRangeValue[1]}
        </div>
      </div>
      <div className="shop-availability-header">AVAILABILITY</div>
      <div className="shop-availability-container">
        <div className="shop-availability-option-container">
          <input
            ...
            type="checkbox"
            onChange={(event) =>
              props.filterChange(event, ["In Stock", "InStock"])
            }
          />
          <div>In Stock</div>
        </div>
